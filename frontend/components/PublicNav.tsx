      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <Magnetic strength={0.2}>
            <Link href="/login" className="premium-button-no-shimmer px-4 py-2 text-gray-200 hover:text-white dark:text-gray-200 dark:hover:text-white">
              Login
            </Link>
          </Magnetic>
          <Magnetic strength={0.25}>
            <Link href="/register?role=CREATOR" className="premium-button-no-shimmer px-5 py-2">
              Create Account
            </Link>
          </Magnetic>
        </div>
