...
export default function OrderVideoPlayer({ fileId, orderId, fileName }: OrderVideoPlayerProps) {
  ...
  useEffect(() => {
    if (viewUrlData?.downloadUrl) {
      setViewUrl(viewUrlData.downloadUrl)
    }
  }, [viewUrlData])
              ...
              >
                <div className="flex justify-between items-start">
                  ...
                  <span className={`px-2 py-1 text-xs rounded ${
                    message.resolved ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800'
                  }`}>
