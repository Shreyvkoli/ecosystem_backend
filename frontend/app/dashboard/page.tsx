                ...
                {isLoadingAllEditors ? (
                  ...
                  <div className="space-y-4">
                    {filteredEditors.map((editor: any) => {
                      ...
                      const display = getEditorDisplayData(editor);
                      return (
                        <div key={editor.id} className="bg-white border border-gray-200 rounded-2xl p-6 hover:shadow-md transition-all duration-200 relative">
                          {/* Boosted Label */}
                          {display.boosted && (
                          ...
                          <div className="flex flex-col md:flex-row md:items-start gap-5">
                            ...
                            <div className="flex-shrink-0 relative self-start">
                              <div className="w-14 h-14 rounded-full overflow-hidden border border-gray-200 bg-gray-50 flex items-center justify-center">
                                {editor.avatarUrl ? (
                                  ...
                                  <span className="text-lg font-bold text-green-700 bg-green-50 w-full h-full flex items-center justify-center">
                                    {editor.name.charAt(0).toUpperCase()}
                                  </span>
                                )}
                              </div>
                              <div className={`absolute -bottom-1 -right-1 w-4 h-4 border-2 border-white rounded-full ${editor.available ? 'bg-emerald-500' : 'bg-gray-300'}`} />
                            </div>
                            ...
                            <div className="flex-1 min-w-0">
                              <div className="flex items-center justify-between gap-4">
                                <div>
                                  <div className="flex flex-wrap items-center gap-2">
                                    <h3 
                                      className="text-base font-bold text-gray-900 hover:text-green-600 cursor-pointer hover:underline"
                                      onClick={() => setShowProfileModal(editor.id)}
                                    >
                                      {editor.name}
                                    </h3>
                                    {display.badge === "Top Rated Plus" && (
                                      <span className="inline-flex items-center px-1.5 py-0.5 rounded-md text-[10px] font-bold bg-amber-500 text-white gap-0.5">
                                        👑 Top Rated Plus
                                      </span>
                                    )}
                                    {display.badge === "Top Rated" && (
                                      <span className="inline-flex items-center px-1.5 py-0.5 rounded-md text-[10px] font-bold bg-green-600 text-white gap-0.5">
                                        ✓ Top Rated
                                      </span>
                                    )}
                                    {display.badge === "Rising Talent" && (
                                      <span className="inline-flex items-center px-1.5 py-0.5 rounded-md text-[10px] font-bold bg-blue-500 text-white gap-0.5">
                                        ★ Rising Talent
                                      </span>
                                    )}
                                  </div>
                                  <p className="text-sm font-semibold text-gray-800 mt-1">{display.headline}</p>
                                  <p className="text-xs text-gray-400 mt-0.5">{display.location}</p>
                                </div>
                                ...
                                <div className="hidden md:flex items-center gap-2 flex-shrink-0">
                                  ...
                                  <Link
                                    ...
                                    className="px-5 py-2 bg-green-600 hover:bg-green-700 text-white rounded-full font-bold text-xs transition-all shadow-sm"
                                  >
                                    Invite to job
                                  </Link>
                                </div>
                              ...
                              {/* Sub-info Row */}
                              <div className="flex flex-wrap items-center gap-x-6 gap-y-2 mt-4 text-xs font-semibold text-gray-500">
                                <div>
                                ...
                                <div className="flex items-center gap-1.5">
                                  <div className="relative w-4.5 h-4.5 flex items-center justify-center">
                                    ...
                                    <span className="absolute text-[7px] font-bold text-green-700">%</span>
                                  </div>
                              ...
                              <div className="mt-5 bg-gray-50/70 border border-gray-100 rounded-xl p-4 text-xs animate-fade-in">
                                <div className="flex items-center gap-1.5 font-bold text-gray-700 mb-2">
